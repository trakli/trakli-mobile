...
abstract class $BudgetTargetEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({BudgetTargetType type, int? id, String? clientId, String? name});
}
...
class _$BudgetTargetEntityImpl implements _BudgetTargetEntity {
  const _$BudgetTargetEntityImpl(
      {required this.type, this.id, this.clientId, this.name});
  ...
  @override
  String toString() {
    return 'BudgetTargetEntity(type: $type, id: $id, clientId: $clientId, name: $name)';
  }
