...
class ImportRemoteDataSourceImpl implements ImportRemoteDataSource {
  ...
  @override
  Future<FileImportDto> uploadImport(File file) async {
  ...
  @override
  Future<List<FileImportDto>> getImports() async {
  ...
  Future<ImportSessionDto> analyzeDocument(
    ...
    final apiResponse =
        ApiResponse.fromJson(response.data as Map<String, dynamic>);
    return ImportSessionDto.fromJson(apiResponse.data as Map<String, dynamic>);
  }
  ...
  @override
  Future<List<ImportSessionDto>> getSessions() async {
  ...
  @override
  Future<ImportSessionDto> getSession(int sessionId) async {
